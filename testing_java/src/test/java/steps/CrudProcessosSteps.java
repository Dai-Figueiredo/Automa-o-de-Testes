...
public class CrudProcessosSteps {
    ...
    public void oUsuarioIDigitaNoCampoOValor(String campo, String valor) throws Throwable {
    ...
    @E("^o usuário irá visualizar o processo com id (\\d+)$")
    public void oUsuarioIraVisualizarOProcessoComId(String id) {
    ...
    @E("^o usuário visualiza o campo \"([^\"]*)\" com valor \"([^\"]*)\"$")
    public void oUsuarioVisualizaOCampoComValor(String campo, String valor) throws Throwable {
